USE [CMSPRO_ZEUS]
GO
/****** Object:  StoredProcedure [Entity].[spGetDashboardAllCases]    Script Date: 6/16/2023 3:56:14 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	LEFT JOIN [Status].[Status] S ON e.StatusId = S.StatusId
	...
	LEFT JOIN [Entity].vwCaseAge vwCA ON vwCA.entityid = e.EntityId
